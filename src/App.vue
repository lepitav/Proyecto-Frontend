<template>
  <div id="app">
    <div class="relative bgded overlay" style="background-image:url('https://steamuserimages-a.akamaihd.net/ugc/865115722134877435/C62395D37DEFBAC528A5E2BF6D18F355629AC4C2/');"> 
  <!-- ################################################################################################ -->
  <div class="wrapper row2">
    <nav id="mainav" class="hoc clear"> 
      ...
      <ul class="clear">
        ...
        <li><a href="#">Cruceros Espaciales</a></li>
  ...
  <div class="wrapper">
    <div id="pageintro" class="hoc clear"> 
      <!-- ################################################################################################ -->
      <div class="introtxt">
        <img src="https://vignette.wikia.nocookie.net/logopedia/images/5/5b/Star-Wars-Logo_Silver.png/revision/latest?cb=20151106011636">
        <br>
        <br>
        <p>Star Wars es una serie de películas creadas por el cineasta estadounidense George Lucas. Cuentan las historias de diversos personajes en una Galaxia muy muy lejana.</p>
      </div>
      <!-- ################################################################################################ -->
      <div class="clear"></div>
    </div>
...
<div class="wrapper row3">
  <main id="introblocks" class="hoc container clear"> 
    ...
    <ul class="nospace group elements">
      <li class="one_third first" id="filmsbg">
        <article class="elementwrapper">
          <div class="elementinfo">
            <a href="#" class="ahome">
              <h2>PELICULAS</h2>
              <p class="phome">Listado de todas pelicula de Star Wars, con su sinopsis, fecha, director y productor correspondiente.</p>
            </a>
          </div>
        </article>
      </li>
      <li class="one_third" id="charactersbg">
        <article class="elementwrapper">
          <div class="elementinfo">
            <a href="#" class="ahome">
              <h2>PERSONAJES</h2>
      ...
      <li class="one_third" id="spaceshipsbg">
        <article class="elementwrapper">
          <div class="elementinfo">
            <a href="#" class="ahome">
      ...
      <li class="one_third" id="vehiclesbg">
        <article class="elementwrapper">
          <div class="elementinfo">
            <a href="#" class="ahome">
              <h2>VEHICULOS</h2>
      ...
      <li class="one_third" id="planetsbg">
        <article class="elementwrapper">
          <div class="elementinfo">
            <a href="#" class="ahome">
              <h2>PLANETAS</h2>
      ...
      <li class="one_third" id="speciesbg">
        <article class="elementwrapper">
          <div class="elementinfo">
            <a href="#" class="ahome">
              <h2>ESPECIES</h2>
